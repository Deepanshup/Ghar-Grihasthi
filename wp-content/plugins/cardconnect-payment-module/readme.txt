...
WC Pre-Orders tested with v1.5.20
WC Subscriptions tested with v2.6.4
...
The latest version of WooCommerce (v3.7.0) is supported.
...
Note: Assigning custom checkout fields to CardConnect transactions can now be setup in the WooCommerce CardConnect settings page. You must enter valid CardConnect account credentials to view and manage WooCommerce form fields that should be sent along with a transaction. See the below FAQ section for more info.
